...
const OrganizationFeatures = () => {
  return (
    <section id="features" className="w-full px-4 sm:px-6 lg:px-12 py-16 sm:py-20 lg:py-24 xl:py-32 bg-gradient-to-br from-accent/10 to-accent/5">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 sm:mb-16 lg:mb-20">
          <span className="text-xxs uppercase tracking-widest text-primary font-medium mb-3 sm:mb-4 block">
            Enterprise Platform Features
          </span>
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extralight text-foreground mb-4 sm:mb-6 tracking-tighter">
            SaaS
            <br />
            <span className="text-primary">Solutions</span>
          </h2>
          <p className="text-xxs uppercase tracking-wider text-accent/70 max-w-2xl mx-auto px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8 mb-12 sm:mb-16 lg:mb-20">
          {features.map((feature, index) => (
            <Card 
              key={feature.title} 
              className="border border-border bg-background hover:bg-background hover:shadow-xl transition-all duration-300 group"
              style={{ animationDelay: `${index * 100}ms` }}
            >
              <CardContent className="p-6 sm:p-8">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-primary to-primary/80 flex items-center justify-center mb-4 sm:mb-6 group-hover:scale-110 transition-transform duration-300">
                  <feature.icon className="w-4 h-4 sm:w-5 sm:h-5 text-primary-foreground" />
                </div>
                
                <h3 className="text-lg sm:text-xl font-light text-foreground mb-2 sm:mb-3 tracking-tight">
                  {feature.title}
                </h3>
        ...
        <div className="bg-background rounded-3xl border border-border p-8 sm:p-12 text-center shadow-xl">
          <span className="text-xxs uppercase tracking-widest text-primary font-medium mb-3 sm:mb-4 block">
            Looking for Family Solutions?
          </span>
          <h3 className="text-2xl sm:text-3xl md:text-4xl font-extralight text-foreground mb-4 sm:mb-6 tracking-tighter">
            Connect Your
            <br />
            <span className="text-primary">Donor Family</span>
          </h3>
          <p className="text-sm text-muted-foreground leading-relaxed font-light mb-6 sm:mb-8 max-w-2xl mx-auto">
          ...
          <Button asChild size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 sm:px-8 py-4 sm:py-6 text-sm font-medium tracking-wide group">
