...
interface RecipientWaitlistFormData {
  fullName: string;
  email: string;
...
interface RecipientWaitlistFormProps {
  onSuccess?: () => void;
}
...
export default function RecipientWaitlistForm({ 
  onSuccess
}: RecipientWaitlistFormProps) {
  const [formData, setFormData] = useState<RecipientWaitlistFormData>({
    fullName: "",
    email: "",
    relationshipType: "",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error('Error submitting recipient waitlist form:', error);
      toast({
        title: "Error",
